 ...
 *------------------------------------------------------------------
 *
 * $Source: /cvsroot/ext2fsx/src/e2fsprogs/lib/ss/test_ss.c,v $
 * $Revision: 1.1.1.4 $
 * $Date: 2006/06/23 16:47:32 $
 * $State: Exp $
 * $Author: bbergstrand $
 * $Locker:  $
 *
 * $Log: test_ss.c,v $
 * Revision 1.1.1.4  2006/06/23 16:47:32  bbergstrand
 * Imported e2fsprogs 1.39
 *
...
static char const rcsid_test_c[] =
    "$Header: /cvsroot/ext2fsx/src/e2fsprogs/lib/ss/test_ss.c,v 1.1.1.4 2006/06/23 16:47:32 bbergstrand Exp $";
#endif /* lint */
